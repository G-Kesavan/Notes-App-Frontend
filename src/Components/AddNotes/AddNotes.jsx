  ...
  return (
    <div className='relative flex flex-col bg-blue-200 w-[90%] md:w-[65%] h-fit p-5 m-auto rounded-lg gap-1.5'>
        ...
        <div className='flex flex-col gap-1'>
            <label className='input-label text-sm text-blue-950 font-bold'>TITLE</label>
            <input 
                type="text"
        ...
        <div className='flex flex-col gap-1'>
            <label className='input-label text-sm text-blue-950 font-bold'>CONTENT</label>
            <textarea
                type="text" 
                placeholder='Content'
                rows={8}
        ...
        <div>
            <label className='input-label text-sm text-blue-950 font-bold'>TAGS</label>
            <TagInput 
                tags={tags}
                setTags={setTags}
            />
